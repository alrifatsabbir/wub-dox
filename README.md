# 🎓 WUB DOX - University Cover Page Generator
...
- **Quick Generation:** Create high-quality cover pages in less than a minute.
- **Multiple Templates:** Supports Assignments, Lab Reports, Forums, and Homework.
- **Dual Language:** Full support for both **English** and **Bengali**.
- **Privacy Focused:** No data is stored on any server. Everything is processed in your browser.
- **Interactive Tour:** Built-in guide for first-time users using `driver.js`.
...
- All user input is stored in the browser's `localStorage`.
- PDF generation happens purely on the **Client-side**.
- Your data never leaves your device.

## ⚠️ License & Usage (Strictly Enforced)

This project is **Limited Open Source**. By using or interacting with this repository, you agree to the following terms:

1. **No Deployment:** You are **NOT allowed** to clone this repository and deploy it publicly on any hosting platform (Vercel, Netlify, etc.) under your own name or domain.
2. **Non-Commercial:** This project is for personal and educational use only. **Commercial use is strictly prohibited.**
3. **Intellectual Property:** The design, UI, and logic are the intellectual property of **Al Rifat Sabbir**.

> See the [LICENSE](./LICENSE.md) file for the full legal text.

## 🚀 Getting Started

To run this project locally for learning purposes:

1. Clone the repository (HTTPS Method):
   ```bash
   git clone https://github.com/alrifatsabbir/wub-dox.git
   ```
